    ...
    <section class="profile-card" style="view-transition-name: card">
        ...
        <nav>
            <ul class="link-bubbles" style="--i:0;">
                <li class="link-bubble icon flex-v-center">
                    <a href="/education" class="flex-v-center">
                ...
                <li class="link-bubble icon flex-v-center" style="--i:1;">
                    <a href="/work" class="flex-v-center">
                ...
                <li class="link-bubble icon flex-v-center" style="--i:2;">
                    <a href="/hobbys" class="flex-v-center">
                ...
                <li class="link-bubble icon flex-v-center" style="--i:3;">
                    <a href="/facts" class="flex-v-center">
                ...
                <li class="link-bubble toggler flex-v-center">
