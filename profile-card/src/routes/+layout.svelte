...
<svelte:head>
	<title>Profile Card Dylan</title>
	<meta name="description" content="Dit is de Profile card van Dylan van Nierop, student aan de AD FDND">
